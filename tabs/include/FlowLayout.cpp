...
FlowLayout::FlowLayout(QWidget *parent, const int margin, const int hSpacing, const int vSpacing): QLayout(parent), m_hSpace(hSpacing), m_vSpace(vSpacing) {
...
int FlowLayout::smartSpacing(const QStyle::PixelMetric pm) const {
    ...
    if (!parent) {
        ...
        const QWidget *pw = static_cast<QWidget *>(parent);
